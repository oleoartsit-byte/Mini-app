import {
  require_jsx_runtime
} from "./chunk-2P42PYGN.js";
import {
  __commonJS,
  __require,
  __toESM,
  require_react
} from "./chunk-ARIQWXKT.js";
...
function createResource2(pSource, pFetcher, pOptions) {
  ...
  function load(refetching = true) {
    ...
    if ("v" in p2) {
      if (p2.s === 1)
        loadEnd(pr, p2.v, void 0, lookup);
      else
        loadEnd(pr, void 0, castError(p2.v), lookup);
      return p2;
    }
    scheduled = true;
...
function Switch(props) {
  ...
  return createMemo(() => {
    ...
    return fn ? untrack(() => child(mp.keyed ? conditionValue() : () => {
      var _a2;
      if (((_a2 = untrack(switchFunc)()) == null ? void 0 : _a2[0]) !== index)
