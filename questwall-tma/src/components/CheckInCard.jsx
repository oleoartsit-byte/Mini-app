...
export function CheckInCard({ checkInData, onCheckIn, onMakeup, t }) {
  ...
  const styles = {
    section: {
      background: 'linear-gradient(135deg, rgba(55, 50, 75, 0.95) 0%, rgba(45, 40, 65, 0.92) 100%)',
    ...
    iconWrapper: {
      ...
      height: 44,
      borderRadius: 12,
      background: 'linear-gradient(135deg, #ffc107 0%, #ffeb3b 50%, #ff9500 100%)',
      display: 'flex',
      alignItems: 'center',
    ...
    checkInButton: {
      ...
      fontFamily: "'Orbitron', sans-serif",
      borderRadius: 12,
      border: todayChecked ? '1px solid rgba(57, 255, 20, 0.5)' : '1px solid rgba(255, 255, 255, 0.25)',
      background: todayChecked
        ? 'linear-gradient(135deg, rgba(57, 255, 20, 0.25), rgba(57, 255, 20, 0.15))'
        : 'linear-gradient(135deg, #ffc107 0%, #ffeb3b 50%, #ff9500 100%)',
      color: todayChecked ? '#39ff14' : '#000',
      cursor: todayChecked ? 'default' : 'pointer',
      boxShadow: todayChecked
        ? '0 2px 8px rgba(57, 255, 20, 0.25)'
