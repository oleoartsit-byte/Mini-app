...
export const locales = {
  zh: {
    ...
    checkIn: {
      ...
      todayReward: '今日奖励',
      streak: '连续签到',
      totalDays: '累计 {total} 天 | 连续 {streak} 天',
      day: '天',
      days: '天',
      checkInBtn: '签到',
      checkedIn: '已签到',
      alreadyChecked: '该日期已签到',
      makeup: '补签',
      makeupCost: '消耗 {cost} 积分',
      makeupSuccess: '补签成功！消耗 {cost} Stars，获得 {reward} Stars',
      checkInSuccess: '签到成功！连续 {streak} 天，+{reward} Stars',
      selectDate: '选择要补签的日期',
      today: '今',
      missed: '漏',
    ...
    quest: {
      ...
      verify: {
        ...
        pleaseWait: '请稍候',
        success: '验证成功！',
        rewardSuccess: '验证成功！奖励已发放！',
        completing: '任务即将完成',
        failed: '验证未通过',
        submitFailed: '提交失败',
        submitFailedRetry: '提交失败，请稍后重试',
        verifyFailedRetry: '验证失败，请稍后重试',
        followFirst: '请先关注频道后再验证',
        joinFirst: '请先加入群组后再验证',
        completeFirst: '请先完成任务后再验证',
        bindTwitterFirst: '请先绑定 Twitter 账号',
        pendingReview: '截图已提交，等待审核',
  ...
  en: {
    ...
    checkIn: {
      ...
      streak: 'Streak',
      totalDays: 'Total {total} days | Streak {streak} days',
      day: 'day',
      days: 'days',
      checkInBtn: 'Check In',
      checkedIn: 'Checked In',
      alreadyChecked: 'Already checked in on this date',
      makeup: 'Make Up',
      makeupCost: 'Cost {cost} Points',
      makeupSuccess: 'Make up success! Cost {cost} Stars, got {reward} Stars',
      checkInSuccess: 'Check-in success! {streak} days streak, +{reward} Stars',
    ...
    quest: {
      ...
      verify: {
        ...
        success: 'Verified!',
        rewardSuccess: 'Verified! Reward sent!',
        completing: 'Quest completing',
        failed: 'Verification failed',
        submitFailed: 'Submit failed',
        submitFailedRetry: 'Submit failed, please try again',
        verifyFailedRetry: 'Verification failed, please try again',
        followFirst: 'Please follow the channel first',
        joinFirst: 'Please join the group first',
        completeFirst: 'Please complete the task first',
        bindTwitterFirst: 'Please bind Twitter account first',
        pendingReview: 'Screenshot submitted, pending review',
